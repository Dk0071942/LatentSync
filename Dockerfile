...
RUN apt-get update && apt-get install -y git wget xz-utils libgl1 libglib2.0-0 libgthread-2.0-0 build-essential python3 python3-pip python3-dev --no-install-recommends \
